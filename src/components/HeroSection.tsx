...
export const HeroSection: React.FC<HeroSectionProps> = ({ isDayMode = true }) => {
  ...
  return (
    <section id="monolith" className="relative min-h-[92vh] flex flex-col justify-between pt-16 pb-16 px-4 sm:px-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col items-center text-center my-auto py-12 relative z-10">
        <h1 className={`font-display font-black text-5xl sm:text-7xl md:text-8xl tracking-tight leading-[0.95] mb-6 uppercase max-w-4xl transition-colors duration-500 ${
        ...
        <div className="mb-6">
          <span className={`font-mono font-black text-xs sm:text-sm md:text-base tracking-widest uppercase px-4 py-1.5 border transition-colors duration-500 inline-block ${
            isDayMode
        ...
        <p className={`font-sans font-bold text-base sm:text-xl md:text-2xl max-w-2xl leading-snug tracking-tight mb-10 transition-colors duration-500 px-6 py-4 border ${
          isDayMode
